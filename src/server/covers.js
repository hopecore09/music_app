...
function getText(title, artist) {
  ...
  return `
    <rect x="40" y="130" width="320" height="120" rx="12" fill="rgba(0,0,0,0.35)"/>
    <text x="200" y="180" text-anchor="middle" font-family="Arial,Helvetica,sans-serif" font-size="${ts}" font-weight="700" fill="#ffffff" stroke="rgba(0,0,0,0.5)" stroke-width="3">${esc(title)}</text>
    <text x="200" y="235" text-anchor="middle" font-family="Arial,Helvetica,sans-serif" font-size="${as}" font-weight="300" fill="rgba(255,255,255,0.95)">${esc(artist)}</text>
  `;
}
